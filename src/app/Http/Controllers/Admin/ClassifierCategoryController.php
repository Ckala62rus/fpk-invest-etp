 ...
 *
 * Классификатор — справочник «что закупаем и у кого». Без него все закупки
 * были бы одной кучей. С ним:
 * 1) админ помечает закупку («это СМР у строительного блока»);
 * 2) участник подписывается («хочу только СМР и ИТ»);
 * 3) система шлёт уведомления только по его интересам.
 * Итого: участники находят нужные закупки и не получают лишние письма.
 *
