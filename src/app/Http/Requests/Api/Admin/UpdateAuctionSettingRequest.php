...
class UpdateAuctionSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'idle_timeout_minutes' => ['sometimes', 'integer', 'min:0', 'max:1440'],
    ...
    public function messages(): array
    {
        return [
            ...
            'idle_timeout_minutes.min' => 'Таймаут простоя не может быть отрицательным (0 — выключить автозавершение по простою).',
