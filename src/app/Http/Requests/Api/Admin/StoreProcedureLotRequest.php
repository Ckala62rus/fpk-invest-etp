...
/**
 * Запрос создания лота ТЗП.
 */
class StoreProcedureLotRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'bid_step' => ['required', 'numeric', 'min:0.01'],
    ...
    {
        return [
            'name.required' => 'Наименование лота обязательно для заполнения.',
            ...
            'start_price.required' => 'Начальная цена обязательна для заполнения.',
            'start_price.numeric' => 'Начальная цена должна быть числом.',
            'start_price.min' => 'Начальная цена не может быть отрицательной.',
            'bid_step.required' => 'Шаг ставки обязателен для заполнения.',
