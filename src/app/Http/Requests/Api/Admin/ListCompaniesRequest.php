...
/**
 * Запрос списка предприятий-заказчиков (только super_admin).
 */
class ListCompaniesRequest extends FormRequest
{
    ...
    {
        foreach (['company_group_id', 'search', 'is_active', 'is_external', 'trashed', 'per_page'] as $field) {
    ...
    public function rules(): array
    {
        return [
            ...
            'is_external' => ['sometimes', 'nullable', 'boolean'],
