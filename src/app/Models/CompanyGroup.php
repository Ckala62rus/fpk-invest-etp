...
use Database\Factories\CompanyGroupFactory;
...
{
    /** @use HasFactory<CompanyGroupFactory> */
    use HasFactory;
    use SoftDeletes;
     ...
     *
     * Нужен для справочника категорий (СМР — строительно-монтажные работы,
     * ПИР — проектно-изыскательские работы, ИТ — информационные технологии)
     * и подписки участников на оповещения.
     */
